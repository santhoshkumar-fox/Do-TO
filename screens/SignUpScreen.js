  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <Animated.View layout={LinearTransition}
       ...
       style={styles.loginContainer}>
        ...
        <View style={[StyleSheet.absoluteFill,{}]}>
          <View style={{width:'50%',height:'50%',backgroundColor:COLORS.primarColor30,position:'absolute',right:-40,top:-100,borderTopLeftRadius:140,borderTopRightRadius:40,borderBottomLeftRadius:120,borderBottomRightRadius:100,}}/>
          <BlurView
      ...
      />
        ...
        <Animated.View
        entering={SlideInDown.delay(550).springify().damping(14).stiffness()}
        >
        <InputText
       ...
       <InputText
        ...
        entering={SlideInDown.delay(700).springify().damping(14).stiffness()}
          ...
          <TouchableOpacity
           ...
           style={{width:18,height:18,borderRadius:5,borderColor:COLORS.greyColor,borderWidth:1,alignItems:"center",justifyContent:"center"}}>
           {
            isCheck && 
        ...
        <Animated.View
        entering={SlideInDown.delay(800).springify().damping(14).stiffness()}
         style={{width: '100%'}}>
         {/* button */}
         <View
            style={{
          ...
          <View style={{width:"100%",alignItems:"center",justifyContent:"center",flexDirection:"row"}}>
           <Text style={{...FONTS.lable03,color:COLORS.textColor,marginVertical:SIZE.margin}}>Already have an account?</Text>
           <TouchableOpacity 
           onPress={()=>{
        ...
        {/* or label */}
        <Animated.View
        entering={SlideInDown.delay(900).springify().damping(14).stiffness()}
         style={{width:"100%",alignItems:"center",justifyContent:"center",marginBottom:24}}>
          <Text style={{...FONTS.lable03,color:COLORS.textColor}}>Or</Text>
           ...
           <Animated.View
           entering={SlideInDown.delay(950).springify().damping(14).stiffness()}
            style={{
              width: '100%',
              height: 48,
              borderColor:'white',
